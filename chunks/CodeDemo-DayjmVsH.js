import { vCard, vstack, div, vCode } from '../yoya.esm.min.js';
 ...
 */
function CodeDemo(title, demoContent, codeString = '') {
  return vCard(c => {
...
export { CodeDemo as C };
//# sourceMappingURL=CodeDemo-DayjmVsH.js.map
